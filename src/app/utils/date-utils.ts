...
export class DateUtils {
    ...
    public static getMyDatePickerOptions(disableUntil:boolean) : IMyOptions
    {
        ...
        let myDatePickerOptions: IMyOptions = {
            ...
            disableUntil: disableUntil ? { year: dateNow.getFullYear(), month: dateNow.getUTCMonth() + 1, day: dateNow.getDate() - 1 } : { year: dateNow.getFullYear()-90, month: 1, day: 1 },
            height: '34px',
